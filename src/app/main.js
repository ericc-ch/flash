...
export class MainApp extends LitElement {
  ...
  render() {
    return html`<div class="flex flex-col lg:flex-row flex-wrap">
      <main
      ...
      >
        <section>
          ...
          <p>
            ...
            the Ubuntu-based operating system for your
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              <span title="SuperSpeed">USB 3</span>
              is recommended for faster flashing speed.
            </li>
            <li>
              Another USB-C cable and a charger, to power the device outside
              your car.
            </li>
          </ul>
          ${isWindows ?
        ...
        <section>
          ...
          <ol>
            ...
            <li>
              ...
              <strong>lower</strong>
              <span class="whitespace-nowrap">USB-C</span> port
              <strong>(port 1)</strong>.
            </li>
            <li>
              Second, connect power to the <strong>upper</strong>
              <span class="whitespace-nowrap">OBD-C</span> port
          ...
          ${isLinux ?
            html`
              ...
              <p>
                ...
                the kernel's qcserial driver, and need to be unbound before we
                can access the device. Copy the script below into your terminal
                and run it after plugging in your device.
              </p>
              <copy-text class="block w-full" text=${DETACH_SCRIPT}></copy-text>
            `
          : ""}
          <p>
          ...
          <p>
            The process can take 30+ minutes depending on your internet
            connection and system performance. Do not unplug the device until
        ...
        <section>
          ...
          <p>
            Try using high quality USB 3 cables. You should also try different
            USB ports on the front or back of your computer. If you're using a
            USB hub, try connecting directly to your computer instead.
          </p>
          <h3>My device's screen is blank</h3>
          <p>
            This is normal in QDL mode. You can verify that the "QUSB_BULK"
            device shows up when you press the Flash button to know that it is
            working correctly.
          </p>
          <h3>My device says "fastboot mode"</h3>
          <p>
            You may have followed outdated instructions for flashing. Please
            read the instructions above for putting your device into QDL mode.
          </p>
          <h3>General Tips</h3>
          <ul>
            ...
            <li>
              Try different USB-C cables; low quality cables are often the
              source of problems. Note that the included OBD-C cable will not
              work.
            </li>
          </ul>
        ...
        <div class="hidden lg:block">
          ...
          <a
            href=${`https://github.com/commaai/flash/tree/${version}`}
            target="_blank"
            ><code>${version}</code></a
          >
        </div>
